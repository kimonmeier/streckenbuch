...
namespace Streckenbuch.Server.Data.Migrations
{
    ...
    [Migration("20250517120754_AddedHalteorte")]
    partial class AddedHalteorte
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Streckenbuch.Server.Data.Entities.Halteorte.HalteortHead", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("HalteortHead", (string)null);
                });

            modelBuilder.Entity("Streckenbuch.Server.Data.Entities.Halteorte.HalteortPositions", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<Guid>("HalteortHeadId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("HalteortHeadId");

                    b.ToTable("HalteortPositions", (string)null);
                });
            ...
            modelBuilder.Entity("Streckenbuch.Server.Data.Entities.Halteorte.HalteortPositions", b =>
                {
                    b.HasOne("Streckenbuch.Server.Data.Entities.Halteorte.HalteortHead", "HalteortHead")
                        .WithMany()
                        .HasForeignKey("HalteortHeadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("HalteortHead");
                });
